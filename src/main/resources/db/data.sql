...
insert into job_opening_tb (user_id, title, process, career, career_year, edu, comp_address, dead_line, created_at) values ('5', '카카오 공고글', '채용절차는 코딩테스트 후 면접입니다', '신입', '5년차', '고졸', '부산 장산', now(), now());
...
insert into required_position_tb (position_id, job_opening_id) values('6', '1');
