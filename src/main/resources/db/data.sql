...
insert into resume_tb (user_id, title, resume_pic_url, open_check, user_name, user_email_id, birth, tel, address, sub_intro, career, edu, main_intro, created_at) values ('1', '남은혜 이력서입니다', 'c_img.png', '1', 'cos', 'cos@nate.com', now(), '010-4444-3333', '부산 광안리', '포기하지않는 개발자가 되겠습니다', '경력 3년차', '대졸', '부산/20/남/cos입니다 어렸을때부터 메타코딩 개발자님 영상을 보며 개발자를 꿈꿧습니다.', now());
insert into resume_tb (user_id, title, resume_pic_url, open_check, user_name, user_email_id, birth, tel, address, sub_intro, career, edu, main_intro, created_at) values ('2', '이은지 이력서입니다', 'j_img.png', '1', 'cos', 'cos@nate.com', now(), '010-4444-3333', '부산 광안리', '포기하지않는 개발자가 되겠습니다', '신입', '대졸', '부산/20/남/cos입니다 어렸을때부터 메타코딩 개발자님 영상을 보며 개발자를 꿈꿧습니다.', now());
