...
insert into user_tb (comp_email_id, user_name, user_password, comp_pic_url, comp_history, comp_intro, gubun) values('toss@nate.com','toss', '1234', 'basic.jpg', '1991-02-10', '금융1위 토스입니다', '2');
insert into user_tb (comp_email_id, user_name, user_password, comp_pic_url, comp_history, comp_intro, gubun) values('naver@nate.com', 'naver', '1234', 'basic.jpg', '1994-01-21', '세계1위 네이버입니다', '2');
insert into user_tb (comp_email_id, user_name, user_password, comp_pic_url, comp_history, comp_intro, gubun) values('kakao@nate.com', 'kakao', '1234', 'basic.jpg', '1993-02-10', '메신저1위 카카오입니다', '2');
insert into user_tb (comp_email_id, user_name, user_password, comp_pic_url, comp_history, comp_intro, gubun) values('face@nate.com', 'facebook', '1234', 'basic.jpg', '1994-02-10', 'sns1위 페이스북입니다', '2');
insert into user_tb (comp_email_id, user_name, user_password, comp_pic_url, comp_history, comp_intro, gubun) values('get@nate.com', 'getinthere', '1234', 'basic.jpg', '1988-02-10', 'IT계1위 겟인데어입니다', '2');

-- insert into comp_scrap_tb (created_at) values(now());
-- insert into comp_scrap_tb (created_at) values(now());
-- insert into comp_scrap_tb (created_at) values(now());

insert into job_opening_tb (user_id, title, process, career, career_year, edu, comp_address, dead_line, created_at) values ('4', '네이버 공고글', '채용절차는 코딩테스트 후 면접입니다', '경력자', '1년차', '2년제 이상', '부산 광안리', now(), now());
insert into job_opening_tb (user_id, title, process, career, career_year, edu, comp_address, dead_line, created_at) values ('5', '토스 공고글', '채용절차는 코딩테스트 후 면접입니다', '경력자', '2년차', '4년제 이상', '부산 서면', now(), now());
insert into job_opening_tb (user_id, title, process, career, career_year, edu, comp_address, dead_line, created_at) values ('5', '카카오 공고글', '채용절차는 코딩테스트 후 면접입니다', '경력자', '5년차', '고등학교 졸업 이상', '부산 장산', now(), now());
...
insert into resume_tb (user_id, title, user_name, user_email_id, birth, tel, address, sub_intro, career, career_year, edu, main_intro) values ('1', 'ssar 이력서입니다', 'ssar', 'test1@naver.com', '1990-02-10', '010-1111-2222', '부산 진구 전포동 그린아카데미', '열심히하는 개발자가 되겠습니다', '경력', '4년차', '대졸', '부산/25/남/ssar입니다 어렸을때부터 메타코딩 개발자님 영상을 보며 개발자를 꿈꿧습니다.');
insert into resume_tb (user_id, title, user_name, user_email_id, birth, tel, address, sub_intro, career, career_year, edu, main_intro) values ('1', 'ssar 이력서2입니다', 'cos', 'test2@naver.com', '1995-03-05', '010-2222-3333', '부산 진구 전포동 클럽데이즈', '능력있는 개발자가 되겠습니다', '경력', '2년차', '대졸', '부산/28/남/cos입니다 어렸을때부터 메타코딩 개발자님 영상을 보며 개발자를 꿈꿧습니다.');
insert into resume_tb (user_id, title, user_name, user_email_id, birth, tel, address, sub_intro, career, edu, main_intro) values ('3', 'love 이력서입니다', 'love', 'test3@naver.com', '1994-05-11', '010-5555-1111', '부산 진구 전포동 제이앤제이슨', '꿈과 희망이있는 개발자가 되겠습니다', '신입','대졸', '부산/27/남/love입니다 어렸을때부터 메타코딩 개발자님 영상을 보며 개발자를 꿈꿧습니다.');
